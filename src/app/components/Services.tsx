...
const faqs = [
  { q: "1. What services does your web agency offer?", a: "A sales funnel is a visual representation of the customer journey, from initial awareness to purchase. Our product provides a centralized platform to track and manage leads at each stage of the funnel. You can visualize the progress of leads, identify sales process for maximum efficiency." },
  { q: "2. How long does it take to build a website?", a: "Timelines vary depending on scope. A simple landing page can be done in 1-2 weeks, while complex platforms may take 2-3 months. We always provide a detailed timeline during our initial consultation." },
  { q: "3. Do you provide custom design or use templates?", a: "We always create fully custom designs tailored to your brand. We never use generic templates. Every pixel is crafted specifically for your project." },
  { q: "4. Will my website be mobile-friendly?", a: "Absolutely. Every website we build is fully responsive and optimized for all screen sizes and devices. Mobile-first design is a core part of our development process." },
  { q: "5. Can you redesign my existing website?", a: "Yes, we specialize in website redesigns that modernize your digital presence while preserving your brand identity. We'll audit your current site and recommend improvements." },
];
