...
import { Menu, X, ArrowRight, Twitter, Dribbble, Instagram, Linkedin, ChevronDown, Layers, Palette, Rocket, Laptop } from "lucide-react";
...
const serviceCategories = [
  {
    ...
    icon: Layers,
    links: ["UX UI Consulting", "UX Audit", "UX Research", "Usability Testing", "Wireframe & Prototype", "Design System"]
  },
  {
    title: "Brand Design",
    subtitle: "Crafting Timeless Visuals",
    icon: Palette,
    links: ["Brand Identity", "Corporate Identity", "Brand Strategy", "Motion Graphics", "Graphic Design"]
  },
  {
    title: "MVP Development",
    subtitle: "Launch Your Idea Fast",
    icon: Rocket,
    links: ["MVP for Startup", "MVP App", "MVP Web", "SaaS MVP"]
  },
  {
    title: "Web Design & Dev",
    subtitle: "Creative. Functional. Modern.",
    icon: Laptop,
    links: ["Webflow Development", "SaaS Design", "App Design"]
  }
];
